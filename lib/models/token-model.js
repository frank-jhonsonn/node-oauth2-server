...
function TokenModel(data) {
  ...
  if (data.accessTokenExpiresAt && data.accessTokenExpiresAt.getTime() === 0) {
    delete data.accessTokenExpiresAt;
  }

  if (data.refreshTokenExpiresAt && data.refreshTokenExpiresAt.getTime() === 0) {
